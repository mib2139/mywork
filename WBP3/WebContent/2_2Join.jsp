		...
		<form action="fileUpload.jsp" enctype="Multipart/form-data"
			...
			<div class="login">
				...
				<table>
					...
					<tr>
						<td><input type="password" name="pw" placeholder="Password"
							required="required" />
					</tr>
					...
					<tr>
						<td><input type="file" name="fileName1" /><input
							type="hidden" name="cmd" value="insertmember">
					</tr>


					<tr>
						<td><input type="submit"
							class="btn btn-primary btn-block btn-large" value="JOIN">
					</tr>
				</table>
			</div>
		</form>
