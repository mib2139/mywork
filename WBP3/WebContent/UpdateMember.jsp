...
<body>
	<%
		lb.selectMember(member);
		String id = (String) session.getAttribute("id");
	%>

	<center>
		<img src="./data/<%=id%>.jpg"
			style="width: 300px; height: 300px; object-fit: cover; object-position: top; border-radius: 50%; margin-top: 100px"><br />
		<br />
		<div class="login"></div>
		<form action="fileUpload.jsp" enctype="Multipart/form-data"
			...
			<table>
				...
				<tr align="center">
					<td colspan="2"><input type="text" name="bnum"
						placeholder="branch number" />
				</tr>

				<tr align="center">
					<td colspan="2" style="height: 30px;"><input type="submit"
						value="저장" class="btn btn-primary btn-block btn-large">
				</tr>

			</table>
			<img src="./img/join.png"><a href="deleteAccount.jsp">DeleteAccount</a>
			</div>
		</form>
</body>
</html>
