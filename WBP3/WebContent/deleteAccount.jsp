...
<body>
	<center>
		<form method="get" action="deleteAccountP.jsp">
			<div class="login">
				<img src="./img/user.png"><br/><br/><br/> 
				<input type="text" name="id" placeholder="Username" required="required" value="<%=ssid%>" /> <br> 
				<input type="password" name="pw" placeholder="Password" required="required" /><br> <input type="text" name="pw_check"
					placeholder="enter your password again" required="required" /><br>
				<input type="submit" class="btn btn-primary btn-block btn-large" value="DELETE"> <br />
