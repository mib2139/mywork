...
<body>
	...
	<div align="right">
		...
		%>
		<img src="./data/<%=id%>.jpg" class="smallprofile">
	...
	<center>
		<table border="0" class="status_table" style="font-size: 20px">
			...
			<tr>
				<%
					for (int i = startNo; i < endNo; i++) {
						...
						String pname = inven.getPname();
						String model = inven.getModel();
						String company = inven.getCompany();
						String cate = inven.getCate();
						String amount = inven.getAmount();
						String price = inven.getPrice();
				%>
			...
			%>
			<tr align="center">
				<td colspan="9"><a href="3_Status.jsp"><img alt="맨 앞으로"
						src="./img/double_left.png"></a> <%
 	if (argPage <= 1) {
 %> <img alt="이전" src="./img/right-arrow.png"
					style="width: 21px; height: 21px;"> <%
 	} else {
 %> <a href="3_Status.jsp?page=<%=argPage - 1%>"> <img alt="이전"
						src="./img/right-arrow.png" style="width: 21px; height: 21px;"></a>
					<%
 	}
 %> <%
 	if (argPage >= pageNum) {
 ...
 %> <a href="3_Status.jsp?page=<%=argPage + 1%>"><img alt="이전"
					...
					%> <a href="3_Status.jsp?page=<%=pageNum%>"><img alt="맨 뒤로"
						src="./img/double_right.png"></a></td>
			</tr>
			<tr align="right" style="height: 70px;" style="width: 130px;">
				<td colspan="8" style="height: 41px; border-bottom: 0">
					<form action="4_Insert.jsp" style="width: 125px;">
