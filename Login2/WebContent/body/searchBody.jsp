	...
	<center>
		<table border="1">
			...
			<tr>
				...
				<td><%=member_id%></td>
				<td align="center"><a
					href="updateForm.jsp?body_id=<%=body_id%>"> <img
						src="../images/check.png" title=수정>
				</a> <a href="deleteBody.jsp?body_id=<%=body_id%>"> <img
						src="../images/error.png" title=삭제></a></td>
			</tr>
			...
			<tr>
				...
				<td colspan="3" align="center">
					<form action="searchBody.jsp" method="post">
